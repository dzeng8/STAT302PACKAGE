...
We generate a boxplot of the data to visualize the distribution of the average
mean squared error for each of the chosen number of folds. 

```{r,  fig.width=7}
# create boxplot

ggplot2::ggplot(data = mse_df, ggplot2::aes(x = fold, y = mse)) +
  ggplot2::labs(title = "Average Mean Squared Error", 
                x = "Number of Folds",
